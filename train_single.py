...
for _file_dict in file_dicts:
    ...
    Xseq, yseq = make_sliding_window_single(pmu_vm_normalized, label, window_size=5, stride=5)
...
y = torch.tensor(np.array(y_label)).to(device)
# Dataset details
num_samples = len(X)
...
# Save Model
# =======================
model_path = 'Attack_detector_single.pth'
